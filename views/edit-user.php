...
<body>
    ...
    <main class="row justify-content-center gx-0 w-50 mx-auto my-auto">
        <div class="col-4">
        ...
        <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" id="username" class="form-control" value="<?=$user['username']?>" maxlength="15" required>
            </div>
            <div class="text-end">
